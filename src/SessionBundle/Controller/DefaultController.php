...
//                insertar login de sesion 
    ...
    public function signUpAction(Request $request)
    {
        if ($request->isXMLHttpRequest()) {
            ...
            $user_name_signUpInput = $_POST['user_name_signUpInput'];
            $user_firstGivenName_signUpInput = $_POST['user_firstGivenName_signUpInput'];
            $user_secondGivenName_signUpInput = $_POST['user_secondGivenName_signUpInput'];
            $user_firstFamilyName_signUpInput = $_POST['user_firstFamilyName_signUpInput'];
            $user_secondFamilyName_signUpInput = $_POST['user_secondFamilyName_signUpInput'];
            $user_email_signUpInput = $_POST['user_email_signUpInput'];
            $user_password_signUpInput = $_POST['user_password_signUpInput'];
            $user_biography_signUpTextarea = $_POST['user_biography_signUpTextarea'];
            $user_city_signUpInputSelect = $_POST['user_city_signUpInputSelect'];
            $user_profilePhoto_signUpInput = $_FILES['user_profilePhoto_signUpInput']['name'];

            $city = $em->getRepository('HomeBundle:City')->findOneByCityName($user_city_signUpInputSelect);
            ...
            if (isset($user_v[0]['userId'])) {
                $user_id = "_";
                $user_name = "_";
                $user_firstGivenName = "_";
                $user_secondGivenName = "_";
                $user_firstFamilyName = "_";
                $user_secondFamilyName = "_";
                $user_email = "_";
                $user_password = "_";
                $user_biography = "_";
                $user_city = "_";
