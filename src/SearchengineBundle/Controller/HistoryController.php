        ...
        if ($request->isXMLHttpRequest()) {
            ...
            if ($userId != 0)
            {
                $history = $em->createQuery(
                    ...
                    v.videoAmountComments, v.videoScore, u.userId, u.userName, h.historyId 
            ...
            while (isset($history_v[$i]['videoId'])) {
                    ...
                    if (
                        file_exists("files/".$history_v[$i]['userId'].
                        "/".$history_v[$i]['videoId'].
                        "/".$history_v[$i]['videoImage'])
                        &&
                        file_exists("files/".$history_v[$i]['userId'].
                        "/".$history_v[$i]['videoId'].
                        "/".$history_v[$i]['videoContent'])
                    )
                    {
                        ...
                        $videoScore_Value = $history_v[$i]['videoScore'];
