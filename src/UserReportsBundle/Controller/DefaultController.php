...
namespace UserReportsBundle\Controller;
...
class DefaultController extends Controller
{
    ...
    {
        return $this->render('@UserReports/Default/index.html.twig');
    }
    
    public function getViewsProfileAction(Request $request)
    {
        ...
        if ($request->isXMLHttpRequest()) {
            ...
            $consulta_2 .= "v.videoAmountComments, v.videoScore, u.userId, u.userName ";
            ...
            while (isset($video_v[$i]['videoId'])) {
                ...
                if ($video_v) {
                    ...
                    $videoScore_Value = $video_v[$i]['videoScore'];
